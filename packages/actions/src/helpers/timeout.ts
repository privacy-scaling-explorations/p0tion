 ...
 */
export const timeoutCheck = async (firestore: Firestore) => {
        ...
        const ceremonies = await getOpenedCeremonies(firestore)
                ...
                for (const circuit of circuits) {
                    if (!circuit.data)
                        ...
                        if (!currentContributor)
                            ...
                            const participant = await getDocumentById(firestore, 
