 ...
 */
export var onVerification = function (verification) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 1:
          ...
          console.log(
            "Visit "
              .concat(verification.verification_uri, " on this device to authenticate\nYour auth code: ")
              .concat(verification.user_code)
          )
 ...
 */
//  L'handle è da fare sulla CLI!!!
// export const handleGithubToken = async (ghClientId: string): Promise<string> => {
//     let token: string
...
//         // Request a new token.
//         token = await getOAuthToken(ghClientId)
//         // Store the new token.
