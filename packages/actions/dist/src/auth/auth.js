...
import { getOAuthToken } from "./libs/index.js"
/**
 * Gestisce l'autenticazione OAuth 2.0 con device workflow usando Firebase e Github.
 */
var getNewOAuthTokenUsingGithubDeviceFlow = function (ghClientId) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, getOAuthToken(ghClientId)]
        case 1:
          // Manage OAuth Github token.
          // const ghToken = await handleGithubToken(ghClientId)
          // Request a new token.
          // CLI
