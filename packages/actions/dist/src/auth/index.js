 ...
 */
export var getNewOAuthTokenUsingGithubDeviceFlow = function (clientId) {
 ...
 */
export var signInToFirebaseWithGithubToken = function (firebaseApp, token) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          // Sign in with the credential.
          return [4 /*yield*/, signInWithCredential(getAuth(), exchangeGithubTokenForFirebaseCredentials(token))]
        case 1:
          // Sign in with the credential.
          _a.sent()
          return [2 /*return*/]
...
export var authActions = {
  getNewOAuthTokenUsingGithubDeviceFlow: getNewOAuthTokenUsingGithubDeviceFlow,
  signInToFirebaseWithGithubToken: signInToFirebaseWithGithubToken
}
